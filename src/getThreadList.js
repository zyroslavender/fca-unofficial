  ...
  return function getThreadList(limit, timestamp, tags, callback) {
    ...
    const form = {
      ...
      "queries": JSON.stringify({
        "o0": {
          // This doc_id was valid on 2020-06-27
          // (3129882290383387 on 2020-06-07)
          // (3253745841302430 on 2020-05-26) 
          // (1349387578499440 on 2018-04-04).
          // 
          // Facebook is at it again boiz.
